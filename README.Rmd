...
| {hokey} |  | A [pico package](https://www.rostrum.blog/2021/04/18/pico-pkg/) to explore [the {keypress} package](https://github.com/gaborcsardi/keypress) for games in R | [Source](https://github.com/matt-dray/hokey)<br>[Blog](https://github.com/matt-dray/hokey) |
