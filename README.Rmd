...
These are all hosted on GitHub; none are on CRAN. You can find a refined selection of these on [my R-universe page](https://matt-dray.r-universe.dev/ui#builds). The source for the hex logos is in [my 'stickers' repo](https://github.com/matt-dray/stickers).
...
| {dray} | | Miscellaneous personal functions | [Source](https://github.com/matt-dray/dray)<br>[Site](https://matt-dray.github.io/dray/)<br>[Blog](https://www.rostrum.blog/2018/05/25/cloud-pie/) |
