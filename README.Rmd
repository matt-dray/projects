...
`r emo::ji("man_technologist")` A list of [public GitHub-based projects](https://github.com/matt-dray?tab=repositories) that I, [Matt  Dray](https://www.matt-dray.com), have worked on for fun, mostly. Most things are written about in my blog: [rostrum.blog](https://www.rostrum.blog/).
...
Apps hosted [on shinyapps.io](https://www.shinyapps.io/). <img src='https://img.shields.io/badge/Shiny-shinyapps.io-blue?style=flat&labelColor=white&logo=RStudio&logoColor=blue'>
...
Apps on GitHub, but not hosted. <img src='https://img.shields.io/badge/Shiny-not_hosted-blue?style=flat&labelColor=white&logo=RStudio&logoColor=blue'>
...
Selected presentations. Slides made with [the {xaringan} package](https://slides.yihui.org/xaringan/#1) or [Quarto](https://quarto.org/docs/presentations/revealjs/).
...
These are some other bits and bobs that seem worthwhile to mention. In general you can visit my blog, [rostrum.blog](https://www.rostrum.blog/), for other stuff that I've dabbled with but aren't mentioned specifically on this page.
